...
def convertFromFormat1(jsonObject):
    # location is a "/"-delimited string: country/city/area/factory/section
    locationParts = jsonObject["location"].split("/")

    result = {
        'deviceID': jsonObject['deviceID'],
        'deviceType': jsonObject['deviceType'],
        'timestamp': jsonObject['timestamp'],  # already ms since epoch
        'location': {
...
def convertFromFormat2(jsonObject):
    # timestamp is ISO 8601, e.g. "2021-06-23T10:57:17.783Z"
    ...
    result = {
        ...
        'data': jsonObject['data']  # already shaped as {status, temperature}
    }
    return result
